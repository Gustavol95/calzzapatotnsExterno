export class Config {
  ...
  //static apiUrl = "http://localhost/calzzapato_backend_laravel/public/api/";     /* Jaz Local */
   static apiUrl = "http://192.168.125.244/calzzapato/v1/api/";                     /* Nuevo Lab   */
  //  static apiUrl = "http://192.168.125.142/calzzapato/backend/public/api/";      /* Luisito Local */
