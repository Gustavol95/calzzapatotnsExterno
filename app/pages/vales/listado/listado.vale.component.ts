...
@Component({
    ...
    template: `
        <TabView #element [(ngModel)]="selectedIndex" backgroundColor="#EAEAEA">
            <StackLayout *tabItem="{title: 'FÍSICOS'}" >
                <GridLayout columns="65,*,*" rows="65,auto,auto,auto,auto,auto,auto,auto" class="cobrado">
                    ...
                    <Label text="557720" row="0" col="1" style="font-size: 18px;font-weight: bold;"></Label>
                    <Label text="$1,700.00" row="0" col="2" style="font-size: 18px;font-weight: bold;text-align: right;"></Label>
                    <Label text="Cliente" row="1" col="1"></Label>
                    <Label text="Luisa Martinez" row="1" col="2" style="font-weight: bold;text-align: right;"></Label>
                    <Label text="Fecha Asignado" row="2" col="1"></Label> 
                    <Label text="15 Sep 2016" row="2" col="2" style="font-weight: bold;text-align: right"></Label>
                    ...
                    <Label text="26 Sep 2016" row="4" col="2" style="font-weight: bold;text-align: right"></Label>
                    <Label text="Lugar de Compra" row="5" col="1"></Label>
                    <Label text="Calzzapato, Plaza Fiesta" row="5" col="2" style="font-weight: bold;text-align: right"></Label>
                    <Label text="Pago Quincenal" row="6" col="1"></Label> 
                    <Label text="$212.50" row="6" col="2" style="font-weight: bold;text-align: right"></Label>
                    <GridLayout row="7" col="0" colSpan="3" style="background-color: #223D98;margin: 10px 0px 0px 0px;padding: 5px 15px 5px 0px; color: white;">
                        <GridLayout columns="auto,auto,auto,*" rows="auto" style="margin: 0;padding: 0"> 
                            <Label text="COBRADO" row="0" col="0" style="font-weight: bold" horizontalAlignment="center" verticalAlignment="center"></Label>
...
export class ListadoValeComponent implements OnInit {
    public vales: any[];
    listLoaded = false;
    constructor(private routerExtensions: RouterExtensions, private page: Page, private _valeService: ValeService) {
        /*this._valeService.index().subscribe(clientes => {
            this.vales = clientes.data;
